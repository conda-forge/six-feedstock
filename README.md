...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/six-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1921&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/six-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `six` can be installed with `conda`:
...
It is possible to list all of the versions of `six` available on your platform with `conda`:
...
```
mamba search six --channel conda-forge
```
...
mamba repoquery search six --channel conda-forge

# List packages depending on `six`:
mamba repoquery whoneeds six --channel conda-forge

# List dependencies of `six`:
mamba repoquery depends six --channel conda-forge
```
